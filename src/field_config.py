...
UNIQUE_FIELDS = {
    ...
    "ihale_konusu": {
        ...
        "type": "text",
        "placeholder": "Örn: Ofis mobilyası alımı",
        "help": "İhale konusunu farklı kalemlerden oluşsa da genel olarak açıklayan bir ifade giriniz",
        "required": True,
        "category": "İhale Bilgileri",
        "order": 21,
    },
    ...
    "fiziki_miktar_ve_tur": {
        ...
        "type": "list",
        "placeholder": "Örn:100 adet bilgisayar",
        "help": "İhaleye konu olan alım kalemlerini  (mal/hizmet/yapım) miktarı ile  satır satır belirtiniz. Davet mektubunda (i), (ii), (iii) olarak listelenecektir.",
        "required": True,
        "category": "İhale Bilgileri",
        "order": 26,
    },
